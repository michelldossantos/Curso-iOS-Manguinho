...
class RemoteAddAccountTests: XCTestCase {
    ...
    func test_add_should_complete_httpClient_with_error_if_client_completes_with_error() {
        let (sut, httpClientSpy) = makeSut()
    ...
    func test_add_should_complete_with_account_if_cllient_completes_with_valid_data() {
        let (sut, httpClientSpy) = makeSut()
        let exp = expectation(description: "waiting")
    ...
    func test_add_should_complete_httpClient_with_error_if_client_completes_with_invalid_data() {
        let (sut, httpClientSpy) = makeSut()
        let exp = expectation(description: "waiting")
        sut.add(addAccountModel: makeAddAccountModel()) { result in
            switch result {
